  ...
  return (
    <div className="flex flex-col items-center mb-10">
        <div className="flex justify-between items-center w-full max-w-[1600px] h-full py-10 mt-5">
            <h2 className="text-gray-800 text-4xl font-semibold font-sans">Homes For You</h2>
        ...
        <div className="flex gap-5 max-w-[900px] lg:max-w-[1080px] xl:max-w-[1600px]  h-full overflow-x-scroll scroll scroll-smooth whitespace-nowrap">
